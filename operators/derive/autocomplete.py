...
def autocomplete_flow():
    ...
    return DF.Flow(
        ...
        DF.set_type('query', **{'es:autocomplete': True, 'es:boost': True}),
        DF.set_type('query_heb', **{'es:boost': True}),
        DF.set_type('structured_query', **{'es:boost': True, 'es:hebrew': True}),
        DF.set_type('response', **{'es:keyword': True}),
        DF.set_type('situation', **{'es:keyword': True}),
        DF.set_type('org_id', **{'es:keyword': True}),
        DF.set_type('synonyms', **{'es:itemType': 'string', 'es:boost': True}),
