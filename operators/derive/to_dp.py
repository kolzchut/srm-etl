...
def card_data_flow():
    ...
    return DF.Flow(
        ...
        DF.add_field('responses_parents', 'array', lambda r: [responses.get(s, {}) for s in r['response_ids_parents']], resources=['card_data']),
        DF.add_field('situation_ids_parents', 'array', lambda r: [responses.get(s, {}) for s in r['situation_ids_parents']], resources=['card_data']),
