...
AIRTABLE_BASE ="appGNajPmotY4U8ny" #  Replaced for testing purposes only get_env('ETL_AIRTABLE_BASE')
...
AIRTABLE_STAGING_BASE = "appGNajPmotY4U8ny" # Replaced for testing purposes only "appxUxbrRRoUiSB4P"
